 ...
 * inset, which is what a printed atlas does for the same reason. Neither view
 * is the whole globe; see the note on `world` below for what was cropped and
 * why that is safe.
 *
...
const lines = [
  ...
  '// polygons (public domain). Two equirectangular views: the part of the world',
  '// this atlas has worlds in, and a Europe inset — because at picker size the',
  '// atlas’s European worlds overlap each other.',
  '//',
