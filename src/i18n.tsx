...
const DICT: Dict = {
  ...
  groupEpic: { en: 'National epics & folk tales', et: 'Rahvuseeposed ja muinasjutud' },
  groupAdventure: { en: 'Classic adventure', et: 'Klassikaline seiklus' },
  groupFantasy: { en: 'Modern fantasy', et: 'Kaasaegne fantaasia' },
  groupOriginal: { en: 'Original worlds', et: 'Algupärased maailmad' },
  groupOther: { en: 'Other worlds', et: 'Muud maailmad' },
  findWorld: { en: 'Find a world…', et: 'Otsi maailma…' },
  noWorlds: { en: 'No world matches that.', et: 'Ükski maailm ei sobi.' },
