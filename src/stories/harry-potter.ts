...
export const harryPotter: Story = {
  ...
  terrain: {
    music: {
      ...
      credit: 'English traditional · public domain',
      melody:
        'A3:3 A3:3 E4:3 E4:2 B3:1 C4:2 B3:1 A3:3 G3:3 A3:3 r:3 A3:3 C4:2 D4:1 E4:3 D4:2 C4:1 B3:3 A3:6 r:3',
      bass: 'A2:6 G2:6 A2:6 E2:6',
      tempo: 100,
      voice: 'flute',
      mood: 'mystic',
    },
